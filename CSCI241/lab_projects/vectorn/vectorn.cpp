...
vectorn vectorn::operator+ ( const vectorn& rhs ) const {
    size_t smaller_capacity = v_capacity < rhs.v_capacity ? v_capacity : rhs.v_capacity;

    double* result_array = new double[smaller_capacity];

    vectorn result(result_array, smaller_capacity);
...
vectorn vectorn::operator*(double rhs) const {
    double* result_array = new double[v_capacity];

    vectorn result(result_array, v_capacity);
